...
//    }
	...
	// kiem tra thong tin myaccount
		public MyAccount checkMyAccount(int mid) {
			...
			try {
				...
				rs = ps.executeQuery();
				while (rs.next()) {
					return new MyAccount(rs.getInt(1), rs.getString(2), rs.getInt(3), rs.getString(4), rs.getString(5),rs.getString(6));
